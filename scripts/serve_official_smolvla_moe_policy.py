...
from smolvla_moe.official.serving import LiberoOfficialSmolVLAMoEPolicy


def main() -> int:
    parser = argparse.ArgumentParser(description="Serve an official SmolVLA residual-MoE checkpoint.")
    ...
    policy = LiberoOfficialSmolVLAMoEPolicy(
    ...
    logging.info("Serving official SmolVLA-MoE on %s:%d with metadata=%s", args.host, args.port, policy.metadata)
